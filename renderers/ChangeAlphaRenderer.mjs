class ChangeAlphaRenderer {
                    ...
                    that.#shaderModule = device.createShaderModule({
                        code: `
                            ...
                            fn main ([[builtin(global_invocation_id)]] global_id: vec3<u32>) {
                                ...
                                //outputPixels.rgba[index] = 0u << 24u | 255u << 16u | 0u << 8u | 0u;
                            }
                        `
                    });
    ...
    renderFrame(frameData) {
        ...
        return new Promise( resolve => {
            ...
            const uniformData = [this.#opacity];
            ...
            gpuOutputBuffer.mapAsync(GPUMapMode.READ).then( () => {
                ...
                /*if (that.#cnt < 5) {
                    console.log(`in : ${this.#cnt}`, frameData);
                    console.log(`out : ${this.#cnt}`, imageData.data);
                }*/
