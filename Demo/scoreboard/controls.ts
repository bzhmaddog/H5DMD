...
export function buildScoreboardControlPanel(dmd: Dmd): void {
    ...
    const scoreSection = section(
        ...
        Colors.Blue,
        score,
        'One compound element (outlined score digits) shown/hidden/faded as a single unit.',
    )
    ...
    const playerSection = section(
        'Player group',
        Colors.Green,
        player,
        '"P" label + player number - two TextLayers moved/shown/hidden together.',
    )
    ...
    const ballSection = section(
        'Ball group',
        Colors.Yellow,
        ball,
        '"BALL" label + ball number - two TextLayers moved/shown/hidden together.',
    )
